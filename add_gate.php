...
if(isset($_POST['sub'])){
  $gno=$_POST['GNo'];
  $gname=$_POST['GName'];
  $query = "INSERT INTO gate VALUES('$gno', '$gname')";
  $result= mysqli_query($conn, $query);
  if($result){
    echo "<script>alert('Gate Added!!!')</script>";
  }else{
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>Add Gate</b></span></h1>
  ...
  <div class="w3-container w3-padding-32" id="contact">
    ...
    <form method="POST">
     <!--  <input class="w3-input w3-border" type="number" placeholder="Guest id" name="Gid"> -->
      <input class="w3-input w3-section w3-border" type="Gate number" placeholder="Gate Number" name="GNo">
      <input class="w3-input w3-section w3-border" type="text" placeholder="Gate Name" name="GName">
