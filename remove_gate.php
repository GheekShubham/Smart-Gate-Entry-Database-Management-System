...
if(isset($_POST['sub'])){
  $gno=$_POST['GNo'];
  $query = "DELETE FROM gate WHERE GateNo=$gno";
  $result= mysqli_query($conn, $query);
  if($result){
    echo "<script>alert('Gate Removed!!!')</script>";
  }else{
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  ...
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>Remove Gate</b></span></h1>
